INSERT INTO galipandb.pais (id_pais, codigo, nombre) VALUES
...
(0,'BI','Burundi'),
(0,'BJ','Benin'),
(0,'BL','Saint Barthélemy'),
(0,'BM','Bermuda'),
(0,'BN','Brunei Darussalam'),
(0,'BO','Bolivia, Plurinational State of'),
(0,'BQ','Bonaire, Sint Eustatius and Saba'),
(0,'BR','Brazil'),
(0,'BS','Bahamas'),
(0,'BT','Bhutan'),
(0,'BV','Bouvet Island'),
...
(0,'MK','Macedonia, the former Yugoslav Republic of'),
(0,'ML','Mali'),
(0,'MM','Myanmar'),
(0,'MN','Mongolia'),
(0,'MO','Macao'),
...
(0,'PN','Pitcairn'),
(0,'PR','Puerto Rico'),
(0,'PS','Palestinian Territory, Occupied'),
(0,'PT','Portugal'),
(0,'PW','Palau'),
(0,'PY','Paraguay'),
(0,'QA','Qatar'),
...
(0,'UY','Uruguay'),
(0,'UZ','Uzbekistan'),
(0,'VA','Holy See (Vatican City State)'),
